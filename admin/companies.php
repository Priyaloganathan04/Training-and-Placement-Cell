    ...
    <div class="content-wrapper" style="margin-left: 0px;">
      <section id="candidates" class="content-header">
        <div class="container">
          <div class="row">
            <br>
            <h3 align="center"><strong>Informations of Companies</strong></h3>
            <br>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr style="text-align: center;">
                              ...
                              <td><a href="delete-company.php?id=<?php echo $row['id_company']; ?>"><i class='fa fa-trash' onclick='return checkdelete()'></i></a></td>
                            </tr>
                        <?php
                          }
                        }
