                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col md-13">
                            ...
                            <h3 style="text-align: center;"> Student applications for various coordinator</h3>
                            <?php

                            $sql1 = "SELECT distinct jobtitle FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_jobpost  INNER JOIN users ON users.id_user=apply_job_post.id_user WHERE apply_job_post.id_coordinator=2";
                            ...
                            <form method="POST">
                                <div class="form-group text-center option">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true" class="input" name="coordinator">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $option = mysqli_real_escape_string($conn, $_POST['coordinator']);
