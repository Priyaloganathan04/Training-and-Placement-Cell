...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE job_post SET jobtitle='$companyname', role='$role', minimumsalary='$CTC', qualification='$qualification', maximumsalary='$Eligibility',  description='$description' where id_jobpost='$_SESSION[id_jobpost] '";
