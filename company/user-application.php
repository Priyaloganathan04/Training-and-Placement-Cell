                      ...
                      <div>
                        ...
                        if ($row['resume'] != "") {
                            ...
                            if (file_exists($resumePath)) {
                                ...
                                echo '<a href="' . $resumePath . '" class="btn btn-info" download="' . $resumeFileName . '">Download Resume</a>';
                            } else {
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3 pull-right">
                            <a href="under-review.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>" class="btn btn-success">Approve Application</a>
                          </div>
                        </div>
                      </div>
