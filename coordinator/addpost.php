...
if (isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO job_post(id_coordinator, jobtitle, description, minimumsalary, maximumsalary, role, qualification) VALUES (?,?, ?, ?, ?, ?, ?)");

	$stmt->bind_param("issssss", $_SESSION['id_coordinator'], $jobtitle, $description, $minimumsalary, $maximumsalary, $role, $qualification);
	...
	// $sql = "INSERT INTO job_post(id_coordinator, jobtitle, description, minimumsalary, maximumsalary, role, qualification) VALUES ('$_SESSION[id_coordinator]','$jobtitle', '$description', '$minimumsalary', '$maximumsalary', '$role', '$qualification')";
