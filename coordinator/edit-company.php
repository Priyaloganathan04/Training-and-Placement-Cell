        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              <div class="row">
                <form action="update-coordinator.php" method="post" enctype="multipart/form-data">
                  <?php
                  $sql = "SELECT * FROM coordinator WHERE id_coordinator='$_SESSION[id_coordinator]'";
                  ...
                  ?>
                      <div class="col-md-6 latest-job ">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" name="coordinatorname" value="<?php echo $row['coordinatorname']; ?>" required="">
                        </div>
                        <div class="form-group">
                          <label>Website</label>
