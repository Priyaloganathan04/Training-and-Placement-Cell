...
<header class="header">
    <nav class="navbar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="my-job-post.php" class="nav-link">Current Drive</a>
            </li>
            
            <li class="nav-item">
                <a href="activity.php" class="nav-link">Programs</a>
            </li>

            <li class="nav-item">
                <a href="mailbox.php" class="nav-link">Mailbox</a>
            </li>
            ...
            <li class="nav-item">
                <a href="settings.php" class="fa fa-gear"></a>
            </li>
        </ul>
