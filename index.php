...
<body>
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
            ...
            <img src="assets/img/hero-carousel/hero-carousel-1.svg" class="img-fluid animated" height="400px" width="475px">
    ...
    <!-- header ends -->
        ...
        <section id="cta" class="cta" style="margin-top:90px;">
            <div class="container" data-aos="zoom-out">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
                        ...
                        <p>The Placement Cell plays a crucial role in locating job
                            ...
                            <br>The placement cell operates round the year to facilitate contacts between coordinator
                            and graduates. The number of students placed through the campus interviews is
                            continuously rising.
                        </p>
                        <a class="cta-btn align-self-start" href="login.php">Get Started</a>
                    </div>
