...
<body class="hold-transition login-page bg-blue-100 text-white">
  ...
  ?>
  <div class="login-box content:centre" style="margin-top: 10%;">
    <div class="login-logo">
      <a href="index.php" style="color:black"><b>Placement Portal</b></a>
    </div>
    <!-- /.login-logo -->
    <div class=" login-box-body bg-blue-200 text-black text-xl">
      <p class="text-white text-2xl login-box-msg text-black">Coordinator</p>
      ...
      <form method="post" action="checkcoordinatorlogin.php">
        ...
        <div class="row">
          ...
          <div class=" col-xs-12">
              <?php
              //If coordinator have successfully registered then show them this success message
              ...
              ?>
              <?php
              //If coordinator Failed To log in then show error message.
              ...
              ?>
              <?php
              if (isset($_SESSION['coordinatorLoginError'])) {
              ?>
                <div>
                  <p class="text-center"><?php echo $_SESSION['coordinatorLoginError'] ?></p>
                </div>
              <?php
                unset($_SESSION['coordinatorLoginError']);
              }
              ?>
          </div>
        </div>
    ...
    <a class="text-xl text-black" href=" register-coordinator.php">Create new account</a>
    <!-- /.login-box-body -->
  </div>
  <!-- /.login-box -->
