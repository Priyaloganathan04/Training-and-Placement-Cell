        ...
        <div class="container" style="margin-top: -20px;">
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              ...
              <input class="form-control input-lg" type="text" id="rno" name="rno" minlength="9" maxlength="9" onkeypress="return validatePhone(event);" placeholder="Register Number *" required>
                </div>
                <div class="form-group">
               ...
               <label for="female" >Female</label>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" type="date" id="dob" min="1995-01-01" max="2010-01-31" name="dob" placeholder="Date Of Birth">
                </div>
              ...
              <div class="col-md-4 latest-job ">
                ...
                <div class="form-group">
                <input class="form-control input-lg" type="text" id="ano" name="ano" minlength="12" maxlength="12" onkeypress="return validatePhone(event);" placeholder="Aadhar Number *" required>
              </div>
              <div class="form-group">
                ...
                <div class="form-group">
                  <textarea class="form-control input-lg" rows="2" id="address" name="address" placeholder="Address"></textarea>
                </div>
              </div>
              ...
              <div class="col-md-4 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="pincode" name="pincode" minlength="6" maxlength="6" onkeypress="return validatePhone(event);" placeholder="Pincode">
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="state" name="state" placeholder="State">
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="course" name="course" placeholder="Course Studying">
                </div>
