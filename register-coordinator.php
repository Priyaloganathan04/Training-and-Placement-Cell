...
<body class="hold-transition skin-green sidebar-mini">
  ...
  <?php
  include 'uploads\register_placement.php';
  ?>
  <div class="wrapper">
      ...
      <section class="content-header">
        <div class="container">
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            ...
            <form method="post" id="registercoordinator" action="addcoordinator.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
              <div class="form-group">
              <input class="form-control input-lg" type="text" id="id" name="id" minlength="9" maxlength="9" onkeypress="return validatePhone(event);" placeholder="Employee ID" required>
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" name="name" placeholder="Full Name" required>
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" name="coordinatorname" placeholder="Designation">
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" name="dept" placeholder="Department">
                </div>
                <div class="form-group">
                ...
                <?php
                //If coordinator already registered with this email then show error message.
  ...
  <script>
    $("#registercoordinator").on("submit", function(e) {
      e.preventDefault();
